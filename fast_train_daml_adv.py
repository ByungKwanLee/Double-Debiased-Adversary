...
if not os.path.isdir(f'checkpoint/daml_adv'): os.mkdir(f'checkpoint/daml_adv')
if not os.path.isdir(f'checkpoint/daml_adv/{args.dataset}'): os.mkdir(f'checkpoint/daml_adv/{args.dataset}')
