...
def train(net, net_logistic, trainloader, optimizer_list, lr_scheduler_list, scaler_list, attack, awp):
    ...
    for batch_idx, (inputs, targets) in prog_bar:
        ...
        # calculate awp
        awp_obj = awp.calc_awp(adv_inputs=adv_inputs1, targets=targets1)
        awp.perturb(awp_obj)
        ...
        with autocast():
            adv_outputs1 = net(adv_inputs1)
            outputs1 = net(inputs1)
            loss = trades_loss(outputs1, adv_outputs1, targets1)
...
def main_worker(rank, ngpus_per_node=ngpus_per_node):
    ...
    for epoch in range(args.epochs):
        ...
        train(net, net_logistic, trainloader, optimizer_list, lr_scheduler_list, scaler_list, attack, awp)
